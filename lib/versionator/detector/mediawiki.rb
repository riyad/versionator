...
module Versionator
  module Detector
    ...
    class Mediawiki < Base
      ...
      set :project_url, "https://www.mediawiki.org"
      set :project_download_url, "https://www.mediawiki.org/wiki/Download"
      ...
      set :newest_version_url, 'https://www.mediawiki.org/wiki/Download'
